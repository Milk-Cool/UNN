...
## Launch
Install NodeJS, then download https://github.com/JC-ProgJava/Handwritten-Digit-Dataset/releases into `training/dataset/`. Then it's just `npm i` to install the dependencies, and `npm start` to start the server on port 40067.
